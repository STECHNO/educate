{/* <Row>
    <Col lg={3} sm={12}>
        <div class="logo">
            <a href="index.html"><img src={logo} alt="EDUCAT" /></a>
        </div>
    </Col>
    <Col lg={9} sm={12}>
        <div class="mainmenu-area pull-right">
            <div class="mainmenu d-none d-lg-block">
                <nav>
                    <ul id="nav">
                        <li class="current"><NavLink to="/">Home</NavLink>
                            <ul class="sub-menu">
            ...
            <ul class="header-search">
                <li class="search-menu" onClick={() => setDisplaySearch(!displaySearch)} >
 ...
 {/* <nav className="main-2 navbar navbar-expand-lg navbar-light">
                                <span className="navbar-brand"><a className="icon" href="/bmc">
                                    <img src={logo} /> </a>
                                </span><button aria-controls="responsive-navbar-nav" type="button" aria-label="Toggle navigation" className="navbar-toggler collapsed">
                                    <span className="navbar-toggler-icon" /></button>
                                <div className="link-main-container navbar-collapse collapse" id="responsive-navbar-nav" style={{}}>

                                    <div className="navbar-nav d-flex  ml-auto">
                                        <div class="current"><NavLink to="/">Home</NavLink></div>
